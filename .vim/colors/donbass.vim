...
" General
hi Normal        ctermfg=232  guifg=#080808  ctermbg=15  guibg=#d0d0d0  cterm=none  gui=none
hi Visual        ctermfg=41   guifg=#000000  ctermbg=15   guibg=#5fafdf  cterm=none  gui=none
...
hi StatusLine    ctermfg=16  guifg=#000000  ctermbg=15  guibg=#a8a8a8  cterm=none  gui=none
hi StatusLineNC  ctermfg=7   guifg=#000000  ctermbg=15 guibg=#a8a8a8  cterm=none  gui=none
hi VertSplit     ctermfg=7   guifg=#000000  ctermbg=15  guibg=#a8a8a8  cterm=none  gui=none
hi TabLine       ctermfg=8   guifg=#000000  ctermbg=15  guibg=#a8a8a8  cterm=none  gui=none
hi TabLineFill   ctermfg=7   guifg=#000000  ctermbg=15  guibg=#a8a8a8  cterm=none  gui=none
hi TabLineSel    ctermfg=7   guifg=#000000  ctermbg=248  guibg=#a8a8a8  cterm=bold  gui=bold
hi WildMenu      ctermfg=250  guifg=#bcbcbc  ctermbg=236  guibg=#303030  cterm=none  gui=none
hi Folded        ctermfg=fg   guifg=fg       ctermbg=bg  guibg=#bcbcbc  cterm=none  gui=none
hi FoldColumn    ctermfg=7  guifg=#af0000  ctermbg=bg  guibg=#bcbcbc  cterm=bold  gui=bold
hi Pmenu         ctermfg=16   guifg=#000000  ctermbg=15  guibg=#a8a8a8  cterm=none  gui=none
hi PmenuSel      ctermfg=16   guifg=#000000  ctermbg=7  guibg=#808080  cterm=none  gui=none
hi PmenuSbar     ctermfg=7   guifg=fg       ctermbg=15  guibg=#808080  cterm=none  gui=none
hi PmenuThumb    ctermfg=251  guifg=#c6c6c6  ctermbg=bg   guibg=bg       cterm=none  gui=none
hi LineNr        ctermfg=7  guifg=#444444  ctermbg=bg   guibg=bg       cterm=none  gui=none
...
hi Title         ctermfg=254  guifg=#e4e4e4  ctermbg=bg  guibg=#df5f5f  cterm=none  gui=none
...
hi DiffChange    ctermfg=fg   guifg=fg       ctermbg=111  guibg=#df5f5f  cterm=none  gui=none
...
" Syntax
hi Identifier    ctermfg=0   guifg=#5f0000  ctermbg=bg   guibg=bg       cterm=none  gui=bold
hi Statement     ctermfg=32   guifg=#008700  ctermbg=bg   guibg=bg       cterm=none  gui=bold
hi Type          ctermfg=32   guifg=#005faf  ctermbg=bg   guibg=bg       cterm=none  gui=bold
hi Constant      ctermfg=32  guifg=#df0000  ctermbg=bg   guibg=bg       cterm=none  gui=none
hi String        ctermfg=172   guifg=#005f5f  ctermbg=bg   guibg=bg       cterm=none  gui=none
hi Special       ctermfg=16  guifg=#af5f5f  ctermbg=bg   guibg=bg       cterm=none  gui=underline
hi PreProc       ctermfg=32   guifg=#00875f  ctermbg=bg   guibg=bg       cterm=none  gui=bold
